...
function makeStyles(colors: AppColors) {
  return StyleSheet.create({
    ...
    catalogGrid: { gap: spacing.xs, marginBottom: spacing.lg },
    catalogItem: {
      width: '100%',
      minHeight: 60,
      borderRadius: radii.md,
    ...
    catalogName: { fontFamily: fonts.sansSemibold, fontSize: 14, color: colors.ink },
    catalogCategory: { fontFamily: fonts.sans, fontSize: 11, color: colors.muted, marginTop: 2 },
    emptySearch: {
      alignItems: 'center',
      gap: spacing.sm,
