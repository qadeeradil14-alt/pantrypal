...
const ICON_GROUPS: readonly ItemIconGroup[] = [
  ...
  { key: 'drink-water', emoji: '💧', aliases: ['water', 'water bottles', 'bottled water', 'drinking water', 'sparkling water', 'mineral water', 'coconut water', 'flavored water', 'alkaline water'], keywords: ['water'] },
  { key: 'drink-bottle', emoji: '🧃', aliases: ['soda', 'cola', 'juice', 'apple juice', 'cranberry juice', 'sports drink', 'energy drink', 'kombucha', 'protein shake', 'meal replacement shake', 'kids juice boxes', 'lemonade drink', 'iced coffee drink'], keywords: ['soda', 'cola', 'juice', 'drink', 'kombucha', 'shake'] },
  ...
  { key: 'baby-diaper', emoji: '🧷', aliases: ['diaper', 'diapers', 'nappy', 'nappies', 'diaper cream', 'diaper rash cream', 'baby rash cream', 'pull ups', 'pull-ups', 'training pants', 'training pants pull ups', 'baby powder'], keywords: ['diaper', 'nappy'] },
  { key: 'baby', emoji: '🍼', aliases: ['baby formula', 'baby food', 'baby bottle', 'formula', 'infant formula', 'baby food pouches', 'baby snacks', 'baby cereal', 'baby food jar'], keywords: ['formula', 'baby'] },
